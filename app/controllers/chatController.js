        ...
        return new Promise((resolve,reject)=>{
            ...
            .exec((err,result)=>{
                if(err){
                    ...
                    console.log('chats are found and listed')
